...
aws ssm put-parameter \
    --name "/service/aws-sam-pipeline-payment/github/repo" \
    --description "Github Repository name for Cloudformation Stack aws-sam-pipeline" \
    --type "String" \
    --value ""

aws ssm put-parameter \
    --name "/service/aws-sam-pipeline-payment/github/token" \
    --description "Github Token for Cloudformation Stack aws-sam-pipeline" \
    --type "String" \
    --value ""

aws ssm put-parameter \
    --name "/service/aws-sam-pipeline-payment/github/user" \
...
aws cloudformation create-stack \
    --stack-name aws-sam-pipeline-payment \
